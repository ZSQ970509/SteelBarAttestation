...
//                        // Provide your custom parameter here
                   //     .addQueryParameter("token", UserLocalData.getToken(ProApplication.getmContext()))
...
//                        .header("timestamp", CommonUtils.getTimeStamp())
//                        .header("nonce", CommonUtils.getSixteenUUId())
            ...
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    retrofit = new Retrofit
                            ...
                            .addConverterFactory(GsonConverterFactory.create(new Gson())) //这里是用的fastjson的
                            .build();
